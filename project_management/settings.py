...
SECRET_KEY = 'django-insecure-m)6k5&ma&flof6uvgx2e5$!npvksejv36)1wtv&#tgqj4*wg0$'
...
INSTALLED_APPS = [
    ...
    'accounts', #app for handling authorizations
    'management', #app for handling project management
    'celery',
]
